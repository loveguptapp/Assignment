...
Deduction 80C:<br><input type="number"  name="cded" placeholder="upto 1.5 lakh" required placeholder="mention 0 rs if no investment"><br>
Deduction 80D:<br><input type="number"  name="dded" placeholder="upto 60000" required ><br>
Income from House:<br><input type="number"  name="house" required><br>
Income from other:<br><input type="number"  name="other" required><br><br>
</h4>
